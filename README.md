# BYTE Exchange - Order Matching Engine & Trading Dashboard

High-performance order matching engine and real-time trading dashboard for `BYTE`.

---

## Project Milestones

- [x] **Milestone 1**: Project Setup (Monorepo, Express, SQLite, React, Vite, TailwindCSS, TypeScript).
